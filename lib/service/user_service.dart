...
import 'package:aivis/models/oauth/user_token_model.dart';
import 'package:aivis/models/user/user_info_model.dart';
import 'package:aivis/requests/oauth_request.dart';
import 'package:aivis/requests/user_request.dart';
...
class UserService extends GetxService {
  ...
  void init() {
    ...
    expires = storage.getValue(
      LocalStorageService.kUserAccessTokenExpiresTime,
